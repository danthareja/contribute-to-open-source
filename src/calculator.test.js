...
describe("_check", async () => {
  ...
  it("should throw a TypeError if arguments are not numbers", () => {
    expect((calculator) => calculator._check(40, "2")).to.throw(TypeError);

    expect((calculator) => calculator._check(40, [])).to.throw(TypeError);
    expect((calculator) => calculator._check(40, {})).to.throw(TypeError);
    expect((calculator) => calculator._check("40", 2)).to.throw(TypeError);
    expect((calculator) => calculator._check([], 2)).to.throw(TypeError);
    expect((calculator) => calculator._check({}, 2)).to.throw(TypeError);
  });
  ...
  it('should be called once in "add"', () => {
    ...
    expect(calculator._check).to.have.been.called.Once;
...
describe("add", () => {
  it("should throw a TypeError if arguments are not numbers", () => {
    expect((calculator) => calculator.add(40, "2")).to.throw(TypeError);
    expect((calculator) => calculator.add(40, [])).to.throw(TypeError);
    expect((calculator) => calculator.add(40, {})).to.throw(TypeError);
    expect((calculator) => calculator.add("40", 2)).to.throw(TypeError);
    expect((calculator) => calculator.add([], 2)).to.throw(TypeError);
    expect((calculator) => calculator.add({}, 2)).to.throw(TypeError);
  });
