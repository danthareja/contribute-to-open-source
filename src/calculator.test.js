...
describe('_check', () => {
  ...
  it('should throw a TypeError if arguments are not numbers', () => {
    expect(() => calculator.exports._check(40, '2')).to.throw(TypeError);
    expect(() => calculator.exports._check(40, [])).to.throw(TypeError);
    expect(() => calculator.exports._check(40, {})).to.throw(TypeError);
    expect(() => calculator.exports._check('40', 2)).to.throw(TypeError);
    expect(() => calculator.exports._check([], 2)).to.throw(TypeError);
    expect(() => calculator.exports._check({}, 2)).to.throw(TypeError);
  });
